...
export default function InterpretedReport({ report, onFeedback }) {
  ...
  const getQualityBadge = () => {
    ...
    return (
      <span className={`px-2 py-1 text-xs font-medium rounded ${colors[report.quality_status] || colors.green}`}>
      ...
      {expanded && (
        <>
          ...
          {report.report?.key_insight && (
            <div className="px-6 py-5 border-b border-slate-100">
              <div className="flex items-start gap-3 p-4 bg-primary-50 rounded border border-primary-100">
                  ...
                  {rating > 0 && (
                    <>
                      <input
                        ...
                        className="flex-1 px-3 py-1.5 text-sm border border-slate-200 rounded focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
                      />
                      <button
                        onClick={handleSubmitFeedback}
                        className="px-4 py-1.5 bg-primary-600 text-white text-sm font-medium rounded hover:bg-primary-700"
                      >
                        Submit
                      </button>
                    </>
