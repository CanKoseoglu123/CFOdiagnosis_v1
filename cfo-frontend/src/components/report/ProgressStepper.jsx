...
export default function ProgressStepper({ currentStep, onStepClick, completedSteps = new Set() }) {
  return (
    <div className="flex items-center justify-center gap-2 py-2 px-4 lg:py-4 lg:px-6 bg-slate-50 border-b border-slate-200">
        ...
        return (
          <div key={step.key} className="flex items-center">
            ...
            >
              ...
              <span
                className={`text-xs mt-1.5 whitespace-nowrap transition-colors hidden lg:block ${
                  isCurrent
